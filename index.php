...
function replace($subject, $values) {
...
$OAUTH2_CLIENT_ID = '931300091879-sb09dfhd0fp78sfff9513i1kksmva6eo.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = 'KEn74Hqr0LX7p888JhBtIa-2';
...
<html lang="en">
  <head>
    ...
    <title>A38 YouTube TV Admin</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">A38 YouTube TV Admin</a>
        </div>
<?php /*
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="?task=updatemeta">Video meták frissítése</a></li>
            <li><a href="?task=videoidlist">Video ID lista</a></li>
<?php /*
            <li class="active"><a href="#">Video ID lista <span class="sr-only">(aktív)</span></a></li>
